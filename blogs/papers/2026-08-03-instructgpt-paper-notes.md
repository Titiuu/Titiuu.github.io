...
> RLHF 并非 InstructGPT 首创。它的关键贡献是把人类示范、偏好建模和强化学习整合成一套面向通用语言模型的后训练流程，使“模型如何回应用户”成为独立于预训练能力的优化目标。
...
论文最重要的证据是 1.3B InstructGPT 在人类偏好上超过 175B GPT-3。它说明模型更强大与模型更符合用户意图，不是同一件事。
